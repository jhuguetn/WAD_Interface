...
<h2 style="font-size:small;font-style:italic;font-weight:normal;">N.B. Optionally character ";" can be used as an "OR" parameter. The supported wildcard characters are "*" and "?"</h2>
